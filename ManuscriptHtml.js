...
var ManuscriptHtml_exports = {};
__export(ManuscriptHtml_exports, {
  MANUSCRIPT_LAYOUT_DEFAULTS: () => MANUSCRIPT_LAYOUT_DEFAULTS,
  MANUSCRIPT_SPACING: () => MANUSCRIPT_SPACING,
  PRINT_PREVIEW_SETTINGS: () => PRINT_PREVIEW_SETTINGS,
  buildManuscriptHtml: () => buildManuscriptHtml,
  buildPaginatedManuscriptHtml: () => buildPaginatedManuscriptHtml,
  buildPrintHtml: () => buildPrintHtml,
  cleanMarkdown: () => cleanMarkdown,
  getManuscriptLayoutMetrics: () => getManuscriptLayoutMetrics,
  manuscriptContentCss: () => manuscriptContentCss,
  manuscriptPrintCss: () => manuscriptPrintCss,
  normalizeSettings: () => normalizeSettings,
  paginatedPrintCss: () => paginatedPrintCss,
  preserveIntentionalBlankLines: () => preserveIntentionalBlankLines,
  renderMarkdownToHtml: () => renderMarkdownToHtml
});
module.exports = __toCommonJS(ManuscriptHtml_exports);
...
function buildManuscriptHtml(markdown, settings = {}, title = "SermonPrint") {
  return `
<!doctype html>
<html>
<head>
...
var buildPrintHtml = buildManuscriptHtml;
